...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../DAC_par.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../DAC_par.gen/sources_1/ip/ila_0/hdl/verilog" \
