...
#
# Script generated by Vivado on Fri Nov 21 13:58:10 +0300 2025
...
# script info
echo -e "vio_0.sh - Script generated by export_simulation (Vivado v2023.2.2 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../DAC_par.gen/sources_1/ip/vio_0/hdl/verilog" +incdir+"../../../../DAC_par.gen/sources_1/ip/vio_0/hdl" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../DAC_par.gen/sources_1/ip/vio_0/hdl/verilog" +incdir+"../../../../DAC_par.gen/sources_1/ip/vio_0/hdl" \
